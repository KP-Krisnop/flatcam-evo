...
class LoudDict(dict):
    ...
    def __copy__(self):
        return LoudDict(self)

    def __deepcopy__(self, memo):
        return LoudDict({k: deepcopy(v, memo) for k, v in self.items()})
...
class LoudUniqueList(list, collections.abc.MutableSequence):
    ...
    def __copy__(self):
        return LoudUniqueList(self)

    def __deepcopy__(self, memo):
        return LoudUniqueList([deepcopy(v, memo) for v in self])
